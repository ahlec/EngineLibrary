...
namespace EngineLibrary.Graphics
{
    ...
    {
        public static void DrawTEST(this SpriteBatch spritebatch)
        {
            Texture2D _test = (Texture2D)LibraryResources._2207913_lg;
            spritebatch.Draw(_test, new Rectangle(5, 5, 100, 100), Color.White);
        }
